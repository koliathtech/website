    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4 py-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <span className="text-sm text-muted-foreground">Join our growing team</span>
        </motion.div>
        ...
        >
          Build the Future at <span className="text-primary">KoliathTech</span>
        </motion.h1>
        ...
        >
          Join a team of innovators, creators, and problem-solvers shaping the next generation of technology solutions.
        </motion.p>
