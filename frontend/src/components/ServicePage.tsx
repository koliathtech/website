...
const ServicesPage: React.FC = () => {
  ...
  const services: Service[] = [
    {
      ...
      features: ["Enterprise Applications", "Legacy System Modernization", "API Development"],
    },
    {
      id: 2,
      icon: <Globe size={32} />,
      ...
      features: ["Full-Stack Development", "E-commerce Solutions", "Progressive Web Apps"],
    },
    {
      id: 3,
      ...
      features: ["iOS & Android", "Cross-Platform Solutions", "UI/UX Design"],
    },
    {
      id: 4,
      ...
      features: ["Cloud Migration", "Infrastructure Management", "DevOps Services"],
    },
    {
      id: 5,
      icon: <Shield size={32} />,
  ...
  return (
    <div className="font-sans min-h-screen text-gray-900 bg-slate-900">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-slate-900 border-b border-sky-950" >
        <div className="max-w-7xl mx-auto flex justify-between items-center py-6 px-4">
          <h1 className="text-2xl font-semibold text-slate-50"></h1>
          <nav className="flex gap-8">
            <a href="#" className="text-neutral-100 hover:text-neutral-400 transition-colors">
              Resources
            </a>
            <a href="#" className="text-neutral-100 hover:text-neutral-400 transition-colors">
              Services
          ...
          <button className="hidden lg:inline-flex h-10 items-center justify-center rounded-lg bg-blue-600 px-5 text-sm font-bold text-white shadow-md transition-colors hover:bg-neutral-400 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark">
                Contact Us
          </button>
        </div>
      </header>
      ...
      <section className="py-32 text-center bg-cover bg-center" style={{
       backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAZe37vGdGJbQOyyKveGhyrPmlLNijTYIsvrV_vliyYluQ9bkz3t859rH2RoW_OEjHBTfwvExx2_2PZufWimRe6UlLdozKQXM2C2zfgnIxK2LRsFYIEQ391ySyoU6qxvnpeTb8B7nlDs6dlkoTltzKaDYs9aLvKghd8DEZv_AA4o6oyFDMpubQK9bMUp-YQfsiVtBGLG-yxSHFg9a--QISz5AcVZoZejSZFa8WvqAU-FAB2l61WFkA1qzvQBgs5nia5mBa-OoXCq-4')"
      }}
>
        ...
        <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-3">
          {services.map((service) => (
            ...
            >
              ...
              <h3 className="text-slate-200 text-2xl font-semibold mb-3">{service.title}</h3>
      ...
      <section className="bg-gray-900 text-white py-32 text-center">
        <div className="max-w-3xl mx-auto">
          <h2 className="text-4xl font-bold mb-4 animate-fadeIn">Ready to Transform Your Business?</h2>
      ...
      <footer className="border-t border-sky-950 py-8 text-center">
        <p className="text-gray-400 text-sm">©️ 2025 Koliath Technology. All rights reserved.</p>
      </footer>
    </div>
  );
};
